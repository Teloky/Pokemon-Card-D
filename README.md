...
-See the relationship for all Pokemon of speed and attack with each color dot correlate with a certain type.

## Findings
-Legendary Pokemon do actually go up by very ever slightly but does have a change in later pokemon. With prediction it would go up as well if I put gen 7+ legendary Pokemons
